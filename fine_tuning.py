...
def main():
    ...
    parser.add_argument(
        "--mlm", action="store_false", help="Train with masked-language modeling loss instead of language modeling."
    )
    parser.add_argument(
    ...
    parser.add_argument("--logging_steps", type=int, default=14006, help="Log every X updates steps.")
    parser.add_argument("--save_steps", type=int, default=14006, help="Save checkpoint every X updates steps.")
    parser.add_argument(
        "--save_total_limit",
        type=int,
        default=None,
